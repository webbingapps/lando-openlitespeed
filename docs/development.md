---
title: Development
description: Learn how to develop and contribute to the Lando OpenLiteSpeed service
---

# Development

This guide contains information to help onboard developers to work on the [OpenLiteSpeed](https://openlitespeed.org/) integration, hereafter referred to as "the plugin".
...
```bash
# Clone this repo
git clone https://github.com/lando/openlitespeed.git && cd openlitespeed
...
This plugin contains various working and tested Lando apps in the [examples](https://github.com/lando/openlitespeed/tree/main/examples) folder. You should use these or create new ones to help with plugin development.
...
This tells Lando that _this_ app should use the source version of the `@lando/openlitespeed` plugin you cloned down in the installation. This is useful because it allows you to isolate development within this repo without interferring with any other apps using the stable and global version of the plugin.
...
```yaml
plugins:
  "@lando/openlitespeed": /path/to/plugin
```
...
If you check out the various READMEs in our [examples](https://github.com/lando/openlitespeed/tree/main/examples) you will notice that they are all Leia tests.
...
yarn add @lando/openlitespeed
# Will pull the most recent GitHub pre-release
yarn add @lando/openlitespeed@edge
```
